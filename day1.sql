...
CREATE DATABASE hmaksoy; -- SQL komutlarında case sensitive yoktur ancak değer atamalarında vardır.
​
-- 3- Database Silme - DDL
DROP DATABASE hmaksoy; -- Silme işleminin yapılabilmesi için Database' den Disconnect yapılması ve sorgu ekranının kapatılması gerekmektedir.
​
